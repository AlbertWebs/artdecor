...
themeBtnParent?.addEventListener("click", function (e) {
    ...
    if (clicked === "rtl-btn") {
        ...
        rtlLink.href = "theme/assets/css/vendors/bootstrap.rtl.css";
        rtlBtn.classList.add("rtlBtnEl")
        localStorage.setItem('rtlcss', 'theme/assets/css/vendors/bootstrap.rtl.css');
    ...
    if (clicked === "ltr-btn") {
        ...
        rtlLink.href = "theme/assets/css/vendors/bootstrap.css";
        localStorage.setItem('rtlcss', 'theme/assets/css/vendors/bootstrap.css');
    ...
    if (clicked === "dark-btn") {
        ...
        feather.replace();
        html.className = "dark"
        darkLink.href = "theme/assets/css/dark.css";
        localStorage.setItem("body", "dark")
        localStorage.setItem('layoutcss', 'theme/assets/css/dark.css');
    ...
    if (clicked === "light-btn") {
        ...
        feather.replace();
        darkLink.href = "theme/assets/css/style.css";
        html.className = " "
        localStorage.setItem("body", " ");
        localStorage.setItem('layoutcss', 'theme/assets/css/style.css');
...
rtlLink.href = localStorage.getItem('rtlcss') ? localStorage.getItem('rtlcss') : 'theme/assets/css/vendors/bootstrap.css';
...
if (darkLink) {
    darkLink.href = localStorage.getItem('layoutcss') ? localStorage.getItem('layoutcss') : 'theme/assets/css/style.css';
}
